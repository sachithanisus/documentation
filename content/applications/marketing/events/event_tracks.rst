...
:icon:`fa-toggle-off ` :guilabel:`Unpublished` switch to :icon:`fa-toggle-on `
:guilabel:`Published`; thus turning it from red to green, and making it accessible for attendees.
